<?php
/*
 * Class components\app\Device_Detect
 *
 * Определяет тип клиентского устройства
 * Взято из https://github.com/serbanghita/Mobile-Detect/blob/master/Mobile_Detect.php
 */
